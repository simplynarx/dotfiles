...
#define RSPAD                   (lrpad / 8) /* padding on right side of status text */
...
struct Client {
	...
	char scratchkey;
	unsigned int tags;
	int isfixed, isfloating, isurgent, neverfocus, oldstate, isfullscreen, isterminal, noswallow, CenterThisWindow, issticky;
	pid_t pid;
	int floatborderpx;
	int issteam;
	Client *next;
...
static void togglescratch(const Arg *arge);
